...
3.  Take a look at the websites that the data come from (linked above).
    ...
    La quinta had locations in Mexico. Denny's has locations in Canada, Mexico and the UK.
...
4.  Now take a look at the data.
    ...
    Using just the data you could possibly take the entire number of resturants and then filter just the US resturants and find the number of location outside the US using that data.
